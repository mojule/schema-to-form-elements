...
const formattedStringTemplate = format_1.FormatDecorator(document, {
...
exports.contactFormExample = {
    ...
    "Unnamed Contact Form Pointers": JSON.stringify(util_1.entriesToPointers(unnamedEntries), null, 2),
    "Named Contact Form Pointers": JSON.stringify(util_1.entriesToPointers(namedEntries), null, 2)
};
