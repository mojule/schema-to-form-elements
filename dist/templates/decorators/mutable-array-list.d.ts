...
export declare const MutableArrayListDecorator: (document: Document, arrayList: SchemaTemplate, templates?: Partial<Templates>) => (schema: JSONSchema4, name?: string, value?: any[] | undefined) => HTMLElement;
